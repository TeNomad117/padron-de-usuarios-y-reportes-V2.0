...
<!--mensaje flash-->
<?php if(session('contratoModificado')): ?>
<div class="alert alert-success">
    <?php echo e(session('contratoModificado')); ?>
...
<!--validacion de errores-->
   ...
   <?php endif; ?>
    ...
    <div class="card">
        <form method="POST" action="<?php echo e(url('/edit/'.$contrato->idnum_contrato.'/update')); ?>">
            <?php echo csrf_field(); ?>
    ...
    <input type="text" name="nombre_razon" class="form-control col-md-9" placeholder="Nombre..." required>
    </div>

    <div class="row form-group">
        <label for="" class="col-2">Codigo Postal</label>
        <input type="text" name="codigo_postal" class="form-control col-md-9">
    </div>

    <div class="row form-group">
        <label for="" class="col-2">Direccion del predio</label>
        <input type="text" name="direccion_predio" class="form-control col-md-9">
    </div>

    <div class="row form-group">
        <label for="" class="col-2">Calles trasversales</label>
        <input type="text" name="calles_trasversales" class="form-control col-md-9">
    </div>

    <div class="row form-group">
        <label for="" class="col-2">Colonia</label>
        <input type="text" name="colonia" class="form-control col-md-9">
    </div>
    ...
    <div class="row form-group">
        ...
        <input type="text" name="estado_servicio" class="form-control col-md-9">
    </div>

    <div class="row form-group">
        <label for="" class="col-2">¿Es pensionado?</label>
        <input type="text" name="pensionado" class="form-control col-md-9">
    </div>

    <div class="row form-group">
        <label for="" class="col-2">Diametro de la toma</label>
        <input type="text" name="diamtero_toma" class="form-control col-md-9">
    </div>

    <div class="row form-group">
        <label for="" class="col-2">¿Tiene cisterta?</label>
        <input type="text" name="sisterna" class="form-control col-md-9">
    </div>

    <div class="row form-group">
        <label for="" class="col-2">Observaciones</label>
        <input type="text" name="observaciones" class="form-control col-md-9">
    </div>

    <div class="row form-group">
        <label for="" class="col-2">Nota al cobrar</label>
        <input type="text" name="nota_cobrar" class="form-control col-md-9">
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheNomad\Desktop\V2\reborn\resources\views/contrato/editform.blade.php ENDPATH**/ ?>