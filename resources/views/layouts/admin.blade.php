          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('cliente/orden')}}"><i class="fa fa-circle-o"></i> Ordenes</a></li>
                <li><a href="{{url('/', 'contratoController@index')}}"><i class="fa fa-circle-o"></i> Contratos</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('cliente/pdf')}}"><i class="fa fa-circle-o"></i>Generar PDF</a></li>
                <li><a href="{{url('cliente/almacen')}}"><i class="fa fa-circle-o"></i>Almacen</a></li>
              </ul>
            </li>
             <li>
              <a href="#">
